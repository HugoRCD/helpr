...
const githubUrl = `https://github.com/login/oauth/authorize?client_id=${config.github.clientId}&redirect_uri=${config.appUrl}/app/providers&response_type=code&scope=repo,read:user,user:email`
